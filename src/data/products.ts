...
export const products: Product[] = [
  ...
  },
  {
    ...
    pros: [
      ...
      "Brand claims clinically proven results in 1 week",
    ...
    faq: [
      {
        ...
        answer:
          "RoC has over 65 years specifically studying retinol in skincare. The brand claims their mineral complex enhances retinol's stability and effectiveness — generic serums often lack this supporting cast.",
      },
      {
        question: "How does this compare to the Neutrogena Rapid Wrinkle Repair?",
        answer:
          "Both are excellent drugstore retinols. RoC's serum format is lighter and faster-absorbing. Neutrogena's Accelerated SA technology may be more beginner-friendly. Both are widely reviewed drugstore retinol options.",
      },
    ],
    featured: false,
    rank: 10,
  ...
  {
    id: 16,
    slug: "eltamd-uv-clear-spf46",
    name: "UV Clear Broad-Spectrum SPF 46",
    brand: "EltaMD",
    asin: "B002MSN3QQ",
    affiliateUrl: "https://www.amazon.com/dp/B002MSN3QQ?tag=asotv068-20",
    price: "$39",
    priceRange: "$25–$50",
    rating: 4.7,
    reviewCount: 81000,
    shortDescription: "The #1 dermatologist-recommended facial sunscreen. EltaMD UV Clear is lightweight, non-comedogenic, and contains niacinamide alongside zinc oxide — providing sun protection while actively improving skin quality.",
    keyIngredients: ["Zinc Oxide 9%", "Octinoxate 7.5%", "Niacinamide 5%", "Hyaluronic Acid"],
    bestFor: "Daily sun protection, acne-prone skin, sensitive skin, post-procedure protection",
    pros: [
      "#1 dermatologist-recommended facial sunscreen",
      "81,000+ reviews at 4.7 stars",
      "Niacinamide addresses uneven tone and puffiness while protecting",
      "Non-comedogenic — won't clog pores",
      "Lightweight, transparent finish under makeup",
    ],
    cons: [
      "Higher price than drugstore sunscreens (~$39)",
      "Mild fragrance from niacinamide (most find it pleasant)",
      "Tinted version available but untinted runs slightly white on deep skin tones",
    ],
    ingredientBreakdown: {
      "Zinc Oxide": "Physical (mineral) UV filter providing broad-spectrum UVA and UVB protection. Non-irritating, immediately effective — no need to wait 15 minutes after application.",
      "Niacinamide 5%": "A meaningful therapeutic dose (not a token amount) — reduces inflammation, strengthens the skin barrier, and addresses uneven pigmentation simultaneously with sun protection.",
      "Hyaluronic Acid": "Provides hydration during the day, preventing the dryness that many physical sunscreens can cause.",
    },
    beforeAfterDescription: "Regular SPF 46 use is the most impactful anti-aging action available — preventing photoaging that causes wrinkles, hyperpigmentation, and textural changes more than any other environmental factor.",
    whoItsFor: "Everyone — but particularly those with acne-prone or sensitive skin who have struggled to find a sunscreen that doesn't break them out, and those who want their SPF to actively improve skin rather than just protect.",
    notFor: "Those who prefer tinted SPF (an EltaMD tinted version exists) or those who want the highest SPF number rather than the most elegant daily-wear formula.",
    howToUse: "Apply as the final morning skincare step, after moisturizer. Use at least 1/4 teaspoon for the face. Reapply every 2 hours during sun exposure. SPF is non-negotiable every morning — UV exposure causes photoaging regardless of clouds or season.",
    faq: [
      {
        question: "Why do dermatologists recommend EltaMD over drugstore sunscreen?",
        answer: "EltaMD's formulations are consistently validated in independent dermatological research, use elegant vehicles that make daily use practical (not greasy, not white-cast), and combine sun protection with therapeutic ingredients like niacinamide. They're also non-comedogenic, which matters for the acne-prone patients dermatologists frequently treat.",
      },
      {
        question: "Is mineral or chemical sunscreen better?",
        answer: "EltaMD UV Clear uses a combination — zinc oxide (mineral) and octinoxate (chemical). For acne-prone and sensitive skin, mineral-dominant formulas are generally better tolerated. For all-day wear under makeup, the lightweight finish of this hybrid formula is ideal.",
      },
    ],
    featured: true,
    rank: 16,
    imageUrl: "",
    category: ["sunscreen", "spf", "dermatologist-recommended", "mineral"],
  },
  {
    id: 17,
    slug: "paulas-choice-peptide-booster",
    name: "RESIST Peptide Booster",
    brand: "Paula's Choice",
    asin: "B00GJHGRFE",
    affiliateUrl: "https://www.amazon.com/dp/B00GJHGRFE?tag=asotv068-20",
    price: "$52",
    priceRange: "$50–$100",
    rating: 4.4,
    reviewCount: 9200,
    shortDescription: "A concentrated peptide serum that signals the skin to produce more collagen and elastin without the irritation of retinol. The standout anti-aging booster for those who want to complement or layer with other actives.",
    keyIngredients: ["Multi-Peptide Complex (Argireline, Leuphasyl, Matrixyl 3000)", "Vitamin C (Ascorbyl Glucoside)", "Squalane", "Niacinamide"],
    bestFor: "Firming, collagen stimulation, layering with retinol or vitamin C, sensitive skin anti-aging",
    pros: [
      "Multi-peptide complex addresses collagen and elastin from multiple angles",
      "Can be layered with retinol without irritation interaction",
      "Paula's Choice ingredient transparency — exact percentages disclosed",
      "Suitable for all skin types including sensitive",
      "Addresses texture and firmness alongside retinol rather than competing with it",
    ],
    cons: [
      "Peptides have less clinical evidence depth than retinoids (though strong mechanistic evidence)",
      "Higher price for a booster serum",
      "Results require 8–12 weeks of consistent use to become visible",
    ],
    ingredientBreakdown: {
      "Argireline (Acetyl Hexapeptide-3)": "Inhibits muscle contraction signals — particularly effective for expression lines around the eyes and forehead. Sometimes called 'topical Botox' (an overstatement, but mechanistically similar at a lower magnitude).",
      "Matrixyl 3000": "A palmitoyl oligopeptide blend with strong clinical evidence for stimulating collagen I, III, and IV synthesis — the peptide with the most consistent results across independent trials.",
      "Niacinamide": "Barrier-strengthening and anti-inflammatory support that makes the serum suitable for sensitive skin while adding its own anti-aging benefits.",
    },
    beforeAfterDescription: "Peptides work gradually on collagen architecture — meaningful improvements in skin firmness and reduction in fine line depth are typically visible at 8–12 weeks of consistent daily use.",
    whoItsFor: "Those who want to layer a complementary anti-aging active with retinol, those who cannot tolerate retinol and want a genuine alternative, and those with specific concerns about expression lines and skin firmness.",
    notFor: "Those looking for immediate visible results — peptides work on the structural level and require consistent long-term use. Not a replacement for retinol if you can tolerate it.",
    howToUse: "Apply after cleansing and toning, before moisturizer. Can be layered with vitamin C in the morning and retinol in the evening without interaction. Apply 2–3 drops, press gently into skin.",
    faq: [
      {
        question: "Do peptides actually work for anti-aging?",
        answer: "Yes — peptides have solid mechanistic evidence for stimulating collagen production, and Matrixyl 3000 in particular has multiple independent clinical trials showing meaningful reductions in wrinkle depth. The evidence base is narrower than retinoids' 40 years of data, but the mechanistic case is strong and the tolerance profile is excellent.",
      },
      {
        question: "Should I use peptides or retinol?",
        answer: "Both — they work through different mechanisms and complement each other. Retinol accelerates cell turnover and directly stimulates collagen synthesis. Peptides signal collagen production through different receptor pathways and address muscle contraction-related lines (Argireline). Using both provides broader anti-aging coverage than either alone.",
      },
    ],
    featured: true,
    rank: 17,
    imageUrl: "",
    category: ["peptides", "firming", "serum", "collagen"],
  },
];
